...
using ReformaTributaria.API.Model.List;
...
public class ReformaTributariaService(ILogger<ReformaTributariaService> logger, [FromKeyedServices("SQLServer")] IDbConnection connection)
{
    ...
    {
        var dados = await connection.QueryAsync<RtcClassificacaoTributariaListaModel>(
            sql: @"
                select
                  RST.RST_COD_CST, RST.RST_DS_SITUACAO_TRIBUTARIA, RST.RST_IND_GIBSCBS, RST.RST_IND_GIBSCBSMONO, RST.RST_IND_GRED,
                  RST.RST_IND_GDIF, RST.RST_IND_GTRANSFCRED, RST.RST_IND_GCREDPRESIBSZFM, RST.RST_IND_REDUTORBC, RCT.RCT_COD_CLASS_TRIB,
                  RCT.RTA_COD_ANEXO, RCT.RCT_DS_CLASS_TRIB, RCT.RCT_NOME_CLASS_TRIB, RCT.RCT_LC_REDACAO, RCT.RCT_LC_214_25,
                  RCT.RCT_TIPO_ALIQUOTA, RCT.RCT_PERC_RED_IBS, RCT.RCT_PERC_RED_CBS, RCT.RCT_IND_GTRIBREGULAR,
                  RCT.RCT_IND_GCREDPRESOPER, RCT.RCT_IND_GMONOPADRAO, RCT.RCT_IND_GMONORETEN, RCT.RCT_IND_GMONORET,
                  RCT.RCT_IND_GMONODIF, RCT.RCT_IND_GESTORNOCRED, RCT.RCT_IND_NFEABI, RCT.RCT_IND_NFE, RCT.RCT_IND_NFCE,
                  RCT.RCT_IND_CTE, RCT.RCT_IND_CTEOS, RCT.RCT_IND_BPE, RCT.RCT_IND_BPETA, RCT.RCT_IND_BPETM, RCT.RCT_IND_NF3E,
                  RCT.RCT_IND_NFSE, RCT.RCT_IND_NFSEVIA, RCT.RCT_IND_NFCOM, RCT.RCT_IND_NFAG, RCT.RCT_IND_NFGAS, RCT.RCT_IND_DERE,
                  RCT.RCT_LINK_LEGISLACAO, RCT.RCT_DT_INI_VIGENCIA, RCT.RCT_DT_FIM_VIGENCIA, RCT.RCT_DT_ATUALIZACAO
                from
