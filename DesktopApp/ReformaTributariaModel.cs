...
public partial class ClassificacaoTributaria
{
        ...
        public long PercentualReduçãoIbs { get; set; }

        [JsonPropertyName("Percentual Redução CBS")]
        public long PercentualReduçãoCbs { get; set; }
        ...
        public DateTimeOffset DataAtualização { get; set; }

        [JsonPropertyName("Anexo")]
        public string Anexo { get; set; }

        [JsonPropertyName("Link Legislação")]
        public Uri LinkLegislação { get; set; }
